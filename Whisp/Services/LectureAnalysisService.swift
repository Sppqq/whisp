...
actor LectureAnalysisService {
    ...
    private func extractMetadata(
        ...
        - reminders: массив до 5 конкретных поручений. Только то, что реально сказано в расшифровке: сделать, выучить, принести или подготовить. Не добавляй общие советы и не выдумывай задания. У каждого элемента короткий title (до 60 символов), подробные notes без воды и dueHint — дословная формулировка срока из лекции (например, «в следующую среду», «на следующей неделе», «через 1 урок»); если срока нет, пустая строка
